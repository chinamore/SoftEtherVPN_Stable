...
#Debian and Ubuntu
#Created 2 17, 2019
#Latest Softether Server Version v4.44-9807-rtm-2025.04.16
#Coded by www.175.es
...
cd /root
apt-get update -y
apt-get install build-essential wget tar -y
...
tar zxf softether-vpnserver-v4.44-9807-rtm-2025.04.16-linux-x64-64bit.tar.gz
cd vpnserver
...
rm -rf softether-vpnserver-v4.44-9807-rtm-2025.04.16-linux-x64-64bit.tar.gz
cd /usr/local/vpnserver
chmod 600 *
chmod 700 vpncmd
chmod 700 vpnserver
#Installing server command
wget https://raw.githubusercontent.com/chinamore/SoftEtherVPN_Stable/master/vpnserver1.sh --no-check-certificate
